            ...
            <div v-if="filteredProducts.length" class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                ...
                <div class="flex flex-col md:flex-row gap-4">
                  ...
                  <div class="flex-grow">
                    <h3 @click="selectProduct(p)" class="font-bold text-lg text-white cursor-pointer hover:text-green-400 transition">
                      {{ p.name }}
                    </h3>
                    
                    <div class="text-gray-400 text-sm mt-2 line-clamp-3">
                    ...
                    <div class="flex justify-between mt-4">
                      <button
                        ...
                        class="btn-warning px-3 py-2 rounded-xl font-medium flex items-center space-x-2">
                      ...
                      <button
                        ...
                        class="btn-danger px-3 py-2 rounded-xl font-medium flex items-center space-x-2">
                        <i class="fas fa-trash"></i>
                        <span>Supprimer</span>
                      </button>
                    </div>
